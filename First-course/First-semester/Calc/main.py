...
"""
Строки 33-56: number_words - базовое задание (числа 0-99)

Строки 59-80: fraction_words - задания 6,7 (дроби)

Строки 83-98: operators - все операции (базовые + доп. задания)

Строки 119-138: text_to_number() - задания 5,6 (отрицательные числа и дроби)

Строки 141-173: number_to_text() - задания 1,2,6,7 (все форматы вывода)

Строки 176-185: detect_period() - задание 2 (периодические дроби)

Строки 200-218: calc() - задания 3,4,8,9,10 (основная логика)

Строки 219-248: main() - пользовательский интерфейс
